...
import io.cyborgcode.roa.ui.playwright.elements.ListUiElement;
 ...
 *
 * <p>Each enum constant defines a specific list container with its Selenium {@link PwBy}
...
public enum ListFields implements ListUiElement {
   ...
   NAVIGATION_TABS(PwBy.css(".nav-tabs"), ListFieldTypes.BOOTSTRAP_LIST_TYPE),
   PAY_BILLS_TABS(PwBy.css(".ui-tabs-nav"), ListFieldTypes.BOOTSTRAP_LIST_TYPE),
   ACCOUNT_ACTIVITY_TABS(PwBy.css(".ui-tabs-nav"), ListFieldTypes.BOOTSTRAP_LIST_TYPE);

   private final PwBy locator;
   private final ItemListComponentType componentType;


   ListFields(final PwBy locator, final ItemListComponentType componentType) {
