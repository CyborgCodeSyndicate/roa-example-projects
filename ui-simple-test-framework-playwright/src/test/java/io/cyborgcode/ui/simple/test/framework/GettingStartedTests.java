...
import io.cyborgcode.roa.ui.playwright.annotatitons.UI;
...
class GettingStartedTests extends BaseQuest {
   ...
   void components_browserButtonInputLinkSelectAlert(Quest quest) {
      quest
            .use(RING_OF_UI)
            .getUiSession().getPage().navigate(getUiConfig().baseUrl());
   ...
   void components_validateUsingSoftAssertions(Quest quest) {
      ...
      quest
            ...
            //.validate().validateTextInField(Tag.I, PAYEE_SPRINT_PLACEHOLDER, true)//todo: Not implemented yet
            .select().selectOption(SelectFields.SP_PAYEE_DDL, PAYEE_BANK_OF_AMERICA)
            .link().click(LinkFields.SP_PAYEE_DETAILS_LINK)
            //.validate().validateTextInField(Tag.I, PAYEE_BANK_OF_AMERICA_PLACEHOLDER, true)//todo: Not implemented yet
            .select().selectOption(SelectFields.SP_PAYEE_DDL, PAYEE_APPLE)
            .link().click(LinkFields.SP_PAYEE_DETAILS_LINK)
            //.validate().validateTextInField(Tag.I, PAYEE_APPLE_PLACEHOLDER, true)//todo: Not implemented yet
            .select().selectOption(SelectFields.SP_PAYEE_DDL, PAYEE_WELLS_FARGO)
            .link().click(LinkFields.SP_PAYEE_DETAILS_LINK)
            //.validate().validateTextInField(Tag.I, PAYEE_WELLS_FARGO_PLACEHOLDER, true)//todo: Not implemented yet
   ...
   void components_validateUsingHardAssertions(Quest quest) {
      ...
      quest
            ...
            //.validate().validateTextInField(Tag.I, PAYEE_SPRINT_PLACEHOLDER)//todo: Not implemented yet
            .select().selectOption(SelectFields.SP_PAYEE_DDL, PAYEE_BANK_OF_AMERICA)
            .link().click(LinkFields.SP_PAYEE_DETAILS_LINK)
            //.validate().validateTextInField(Tag.I, PAYEE_BANK_OF_AMERICA_PLACEHOLDER, false)//todo: Not implemented yet
            .select().selectOption(SelectFields.SP_PAYEE_DDL, PAYEE_APPLE)
            .link().click(LinkFields.SP_PAYEE_DETAILS_LINK)
            //.validate().validateTextInField(Tag.I, PAYEE_APPLE_PLACEHOLDER)//todo: Not implemented yet
            .select().selectOption(SelectFields.SP_PAYEE_DDL, PAYEE_WELLS_FARGO)
            .link().click(LinkFields.SP_PAYEE_DETAILS_LINK)
            //.validate().validateTextInField(Tag.I, PAYEE_WELLS_FARGO_PLACEHOLDER, false)//todo: Not implemented yet
            .complete();
   }
   ...
   void components_validateUsingMixedAssertions(Quest quest) {
      ...
      quest
            ...
            .select().selectOption(SelectFields.SP_PAYEE_DDL, PAYEE_WELLS_FARGO)
            .link().click(LinkFields.SP_PAYEE_DETAILS_LINK)
            //.validate().validateTextInField(Tag.I, PAYEE_WELLS_FARGO_PLACEHOLDER)// todo: Not implemented yet
            .complete();
   }
